...
![Class Distribution](./detection/eda_outputs/class_distribution.png)
...
![Objects per Image](./detection/eda_outputs/objects_per_image.png)
...
![Bounding Box Area Ratio](./detection/eda_outputs/bbox_area_ratio_hist.png)
...
![Aspect Ratio Distribution](./detection/eda_outputs/aspect_ratio_hist.png)
...
![Bounding Box Center Heatmap](./detection/eda_outputs/bbox_center_heatmap.png)
...
![IoU Distribution](./detection/eda_outputs/iou_distribution.png)
...
![Occlusion Score Distribution](./detection/eda_outputs/occlusion_score_hist.png)
...
![Truncation Rate Distribution](./detection/eda_outputs/truncation_rate.png)
...
![Density Distribution](./detection/eda_outputs/density_distribution.png)
...
![Brightness Distribution](./detection/eda_outputs/brightness_hist.png)
...
![Blur Score Distribution](./detection/eda_outputs/blur_score_hist.png)
...
![Extra Ignore Flag Distribution](./detection/eda_outputs/extra_ignore_distribution.png)
...
![Extra Occlusion Distribution](./detection/eda_outputs/extra_occ_distribution.png)
...
![Head Ignore Flag Distribution](./detection/eda_outputs/head_ignore_distribution.png)
...
![Head Occlusion Distribution](./detection/eda_outputs/head_occ_distribution.png)
...
![Head Unsure Flag Distribution](./detection/eda_outputs/head_unsure_distribution.png)
...
## Generated Files
All analysis outputs have been saved to `./detection/eda_outputs/` directory.
